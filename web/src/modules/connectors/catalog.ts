...
export const connectorDefinitions: readonly ConnectorDefinition[] = [
  ...
  connector("file", "File Upload", "Upload governed documents directly to Enterprise Agent", "knowledge", "#6157D9", ["Upload", "Index", "Citations"], "Workspace access", true, FileUp),
