...
from api.admin import AdministrationApi
...
_administration_api = AdministrationApi(
    allow_insecure_development_identity=_allow_insecure_development_identity
)
...
async def chat_stream(body: ChatRequest, request: Request) -> StreamingResponse:
    events = await _workspace_api.chat_events(
...
async def list_chat_collections(request: Request) -> dict[str, Any]:
    return await _workspace_api.list_chat_collections(_request_identity(request))
...
async def get_knowledge_citation(
    ...
    return KnowledgeCitationResponse.model_validate(
        await _workspace_api.get_knowledge_citation(
            _request_identity(request),
            item_id=item_id,
            chunk_id=chunk_id,
        )
...
async def get_knowledge_item_viewer(
    ...
    return KnowledgeItemViewer.model_validate(
        await _workspace_api.get_knowledge_item(
            _request_identity(request),
            item_id=item_id,
            chunk_id=chunk,
        )
...
async def upload_collection_document(
    ...
    return CollectionDocumentUploadResponse.model_validate(
        await _workspace_api.upload_collection_document(
            _request_identity(request),
            collection_id,
...
async def start_document_upload(
    ...
    return DocumentUploadStartResponse.model_validate(
        await _workspace_api.start_document_upload(
            _request_identity(request),
            idempotency_key=idempotency_key,
...
async def complete_document_upload(
    ...
    return DocumentMetadata.model_validate(
        await _workspace_api.complete_document_upload(
            _request_identity(request),
            document_id,
        )
    )
...
async def retry_document_indexing(
    ...
    return CollectionDocumentUploadResponse.model_validate(
        await _workspace_api.retry_document_indexing(
            _request_identity(request),
            document_id,
        )
    )
...
async def search_documents(
    ...
    return SearchResponse.model_validate(
        await _workspace_api.search_documents(
            _request_identity(request),
            query=body.query,
            top_k=body.top_k,
            collection_item_ids=body.collection_item_ids,
...
async def get_document(
    ...
    return DocumentMetadata.model_validate(
        await _workspace_api.get_document(_request_identity(request), doc_id)
    )
...
async def delete_document(
    ...
    await _workspace_api.delete_document(_request_identity(request), doc_id)
...
async def admin_overview(identity: AdminIdentity) -> dict[str, Any]:
    return await _administration_api.overview(identity)


@admin_router.get("/spaces")
async def admin_list_spaces(identity: AdminIdentity) -> dict[str, Any]:
    return await _administration_api.list_spaces(identity)
...
async def admin_get_space(
    ...
    return await _administration_api.get_space(identity, tenant_id)
...
async def admin_update_space(
    ...
    return await _administration_api.update_space(
...
async def admin_list_users(
    ...
    return await _administration_api.list_users(
        identity,
        page=page,
        page_size=page_size,
        search=search,
...
async def admin_create_user(
    ...
    return await _administration_api.create_user(identity, body.model_dump())
...
async def admin_get_user(
    ...
    return await _administration_api.get_user(identity, user_id)
...
async def admin_update_user(
    ...
    return await _administration_api.update_user(
...
async def admin_list_permissions(identity: AdminIdentity) -> dict[str, Any]:
    return await _administration_api.list_permissions(identity)
...
async def admin_list_roles(
    ...
    return await _administration_api.list_roles(
        identity,
        page=page,
        page_size=page_size,
        search=search,
...
async def admin_create_role(
    ...
    return await _administration_api.create_role(identity, body.model_dump())
...
async def admin_get_role(
    ...
    return await _administration_api.get_role(identity, role_id)
...
async def admin_update_role(
    ...
    return await _administration_api.update_role(
...
async def admin_disable_role(role_id: UUID, identity: AdminIdentity) -> Response:
    await _administration_api.disable_role(identity, role_id)
...
async def admin_list_groups(
    ...
    return await _administration_api.list_groups(
        identity,
        page=page,
        page_size=page_size,
        search=search,
...
async def admin_create_group(
    ...
    return await _administration_api.create_group(identity, body.model_dump())
...
async def admin_get_group(
    ...
    return await _administration_api.get_group(identity, group_id)
...
async def admin_update_group(
    ...
    return await _administration_api.update_group(
...
async def admin_replace_group_members(
    ...
    return await _administration_api.replace_group_members(
...
async def admin_delete_group(
    ...
    await _administration_api.delete_group(identity, group_id)
    return Response(status_code=status.HTTP_204_NO_CONTENT)


@admin_router.get("/connectors/capabilities")
async def admin_connector_capabilities(identity: AdminIdentity) -> dict[str, Any]:
    return await _administration_api.connector_capabilities(identity)
...
async def admin_list_integration_connections(
    ...
    return await _administration_api.list_integration_connections(
        identity,
        page=page,
        page_size=page_size,
        search=search,
...
async def admin_create_integration_connection(
    ...
    return await _administration_api.create_integration_connection(identity, body.model_dump())
...
async def admin_get_integration_connection(
    ...
    return await _administration_api.get_integration_connection(identity, integration_connection_id)
...
async def admin_update_integration_connection(
    ...
    return await _administration_api.update_integration_connection(
...
async def admin_delete_integration_connection(
    ...
    await _administration_api.delete_integration_connection(identity, integration_connection_id)
    return Response(status_code=status.HTTP_204_NO_CONTENT)
...
async def admin_validate_integration_connection(
    ...
    return await _administration_api.validate_integration_connection(identity, integration_connection_id)
...
async def admin_list_ingestion_sources(
    ...
    return await _administration_api.list_ingestion_sources(
        identity,
        page=page,
        page_size=page_size,
...
async def admin_create_ingestion_source(
    ...
    return await _administration_api.create_ingestion_source(
...
async def admin_get_ingestion_source(
    ...
    return await _administration_api.get_ingestion_source(identity, source_id)
...
async def admin_update_ingestion_source(
    ...
    return await _administration_api.update_ingestion_source(
...
async def admin_delete_ingestion_source(
    ...
    await _administration_api.delete_ingestion_source(identity, source_id)
    return Response(status_code=status.HTTP_204_NO_CONTENT)
...
async def admin_ingest_source(
    ...
    return await _administration_api.ingest_source(identity, source_id)
...
async def admin_list_source_workflows(
    ...
    return await _administration_api.list_source_workflows(
        identity,
        source_id,
        page=page,
        page_size=page_size,
...
async def admin_get_source_workflow(
    ...
    return await _administration_api.get_source_workflow(
...
async def admin_get_source_status(
    ...
    return await _administration_api.get_source_status(identity, source_id)
...
async def admin_get_source_schedule(
    ...
    return await _administration_api.get_source_schedule(identity, source_id)
...
async def admin_set_source_schedule(
    ...
    return await _administration_api.set_source_schedule(
...
async def admin_delete_source_schedule(
    ...
    await _administration_api.delete_source_schedule(identity, source_id)
    return Response(status_code=status.HTTP_204_NO_CONTENT)
...
async def admin_pause_source_schedule(
    ...
    return await _administration_api.pause_source_schedule(identity, source_id)
...
async def admin_resume_source_schedule(
    ...
    return await _administration_api.resume_source_schedule(identity, source_id)
...
async def admin_list_ingestion_jobs(
    ...
    return await _administration_api.list_ingestion_jobs(
        identity,
        page=page,
        page_size=page_size,
        status=status_filter,
...
async def admin_get_ingestion_job(
    ...
    return await _administration_api.get_ingestion_job(identity, workflow_id)
...
async def admin_retry_ingestion_job(
    ...
    return await _administration_api.retry_ingestion_job(identity, workflow_id)
...
async def admin_cancel_ingestion_job(
    ...
    return await _administration_api.cancel_ingestion_job(identity, workflow_id)
...
async def admin_list_items(
    ...
    return await _administration_api.list_items(
        identity,
        page=page,
        page_size=page_size,
        search=search,
...
async def admin_create_collection(
    ...
    return await _administration_api.create_collection(identity, body.model_dump())
...
async def admin_update_collection(
    ...
    return await _administration_api.update_collection(
        identity,
        item_id,
...
async def admin_get_item(
    ...
    return await _administration_api.get_item(identity, item_id)
...
async def admin_update_item(
    ...
    return await _administration_api.update_item(
...
async def admin_retry_item(
    ...
    return await _administration_api.retry_item(identity, item_id)
...
async def admin_delete_item(
    ...
    await _administration_api.delete_item(identity, item_id)
    return Response(status_code=status.HTTP_204_NO_CONTENT)
...
async def admin_list_access_requests(
    ...
    return await _administration_api.list_access_requests(
        identity,
        page=page,
        page_size=page_size,
        search=search,
...
async def admin_create_access_request(
    ...
    return await _administration_api.create_access_request(identity, body.model_dump())
...
async def admin_get_access_request(
    ...
    return await _administration_api.get_access_request(identity, request_id)
...
async def admin_decide_access_request(
    ...
    return await _administration_api.decide_access_request(
...
async def admin_list_collection_access(
    ...
    return await _administration_api.list_collection_access(
...
async def admin_grant_collection_access(
    ...
    return await _administration_api.grant_collection_access(
...
async def admin_revoke_collection_access(
    ...
    await _administration_api.revoke_collection_access(
        identity,
        item_id,
...
async def admin_list_audit_logs(
    ...
    return await _administration_api.list_audit_logs(
        identity,
        page=page,
        page_size=page_size,
        search=search,
...
async def _service_error(_: Request, exc: Exception) -> JSONResponse:
    ...
    elif isinstance(exc, (IdentityInactiveError, IdentityServiceError)):
